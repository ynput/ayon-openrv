...
ADDON_REPO/package/openrv/1.0.0

If there is command line argument `--output_dir` filled, version folder
(eg. `openrv/1.0.0`) will be created there (if already present, it will be
...
ADDON_NAME: str = "openrv"
ADDON_CLIENT_DIR: str = "ayon_openrv"
